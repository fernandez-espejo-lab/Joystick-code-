...
%Roya modified the code for passive movement in 09/04/2019
%for during tDCS, the beep times has been increased. labjack has been
%added 
commandwindow
...
%% Roya for passive movement
% Initialise Labjack Dave Mc
...
%% end of LabJack 
    ...
    % the audio data
    myBeep = MakeBeep(500,0,freq);%(500,beepLengthsecs, freq); Roya mute te beeps for passive movement
    % PsychPortAudio('FillBuffer', pahandle, [myBeep; myBeep]);
    
    %% define some timing variables
    numtrials = 30; %changed this to 8 as the protocol is now 2 hours long - more power with 8 as opposed to 5/6/7
...
%		Add code to set U3 output to logic 1 
...
if GetSecs >= pistont+0.5 %it looks to see if current time is after time piston activated plus 0.5 seconds DMc
    
%		Add code to reset output of U3 to logic 0 Dave Mc
        ...
        % and only check when piston extended.
            ...
            nextTime = nextTime+sampleTime;  % ???? Dave Mc sampletime is only 1/1200sec
